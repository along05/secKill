    ...
    <div class="layui-row" style="padding-top: 10px">
        ...
        <div class="layui-col-xs8" style="padding: 10px">
            <ul class="bb-info">
                ...
                <li>
                    <button class="layui-btn layui-btn-radius layui-btn-normal" id="buyNow">立即购买</button>
...
<script>
    ...
    ;!function () {
        ...
        var $ = layui.$ ;
        $.getJSON("/getEvalute/${goods.goodsId?string('0')}" , function(json){
            for (var i = 0 ; i < json.length ; i++){
                var eva = json[i] ;
                $("#divEvaluate").append("<h3><span>"+eva.createTime+"评论："+eva.content+"</span></h3>")
            }
        })
    }();
